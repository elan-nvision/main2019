...
var WaveFrame = (function() {
  function WaveFrame(points, parentElement, minPoint, maxPoint, color, alpha) {
    var _this = this;
    ...
    this._ctxColor = color;
    this._ctxAlpha = alpha;
  ...
  _createClass(WaveFrame, [
    ...
    },
    {
      ...
      value: function forceRun() {
        ...
        // that more readily suits multiple items.
        setTimeout(function() {
          _this3._canvas.width = _this3.width;
          _this3._canvas.height = _this3.height;
          setTimeout(function() {
            _this3._parentElement.appendChild(_this3._canvas);
            _this3.updated = true;
          }, 0);
        }, 100);
      }
    },
    {
      ...
      value: function run(delta) {
        ...
        this._ctx.beginPath();
        this._ctx.fillStyle = this._ctxColor;
        this._ctx.globalAlpha = this._ctxAlpha;
